...
<head>
	...
	<?php
		...
		$titre = "Vivatech 2k18";
		$sstitre = "Data: an unexpected cornerstone for innovation";
		$description = "Vivatech 2k18 - Data: an unexpected cornerstone for innovation";
		$urlimageaccueil = "http://www.ejc.fr/blog/src/2018/art18_008_2/1.png";
		$num_arc = "18_008_2"; //AA_NNN
		$date_publ= mktime(0,0,0,7,28,2018); // heure minute seconde mois jour année
		...
		$arrayURL = array(1 => "src/2018/art18_008_2/1.jpg",2 => "src/2018/art18_008_2/2.jpg",3 => "src/2018/art18_008_2/3.jpg");
		$arrayLabel = array(1 => "Le DevCo aau salon Vivatech", 2=> "Test de la réalité virtuelle pour Margot",3 => "Test de la reconnaissance vidéo pour Guillaume" );
	...
	//Auteur de l'article
		...
		$nom_auteur = "Guillaume Hoffman"; //"Prénom Nom" ou "le pôle XXX"
		$titreAuteur = "Responsable pôle Developpement Commercial"; //non utilisé si article écrit par un pôle. Exemple: "vice-présidente"
		$imgAuteur = "images/pole/guillaume.png"; //URL de la photo de l'auteur
		$mail_ejc = "guillaume.hofmann@eleve.ensai.fr";
		// Corps de l'article
		...
		<div class="container clearfix">			
			...
			<div class="twelve columns">            		
				...
				<ul class="main-menu large nav" id="nav">
					<li class="bouton"><a class="boutondevis" href="http://www.ejc.fr/devis.html">Faire un devis</a></li>              
					<li><a href="http://www.ejc.fr/#about">Présentation</a></li>
					<li><a href="http://www.ejc.fr/#services">Prestations</a></li>
					<li><a href="http://www.ejc.fr/#team">L'équipe</a></li>
					<li><a href="http://www.ejc.fr/#contact">Contact</a></li>
					<li><a href="http://www.ejc.fr/blog/index.html" style="color:white; font-size:0px">Blog<img src="images/motBlog.png" onmouseover="this.src='images/motBlogBlue.png'" onmouseout="this.src='images/motBlog.png'" title="Blog" alt="Blog"/></a></li>
					</ul>
					...
					<div class="sidebar">
						<div class="widget">
							<div class="widget-title">Partager l'article</div>
								<div class="social-icon social-facebook"><a href="<?php echo "http://www.facebook.com/sharer.php?u=www.ejc.fr/blog/art".$num_arc.".php" ?>" target="_blank" data-original-title="Facebook">Facebook</a></div>
								<div class="social-icon social-twitter"><a href="<?php echo "https://twitter.com/intent/tweet?text=www.ejc.fr/blog/art".$num_arc.".php" ?>" target="_blank" data-original-title="Twitter">Twitter</a></div>
								<div class="social-icon social-linkedin"><a href="<?php echo "https://www.linkedin.com/sharing/share-offsite?mini=true&url=http://www.ejc.fr/blog/art".$num_arc."&title=Blog de EjC - ".$titre."&summary=".$description."&source=ejc.fr" ?>" target=\"_blank\" data-original-title=\"LinkedIn\">LinkedIn</a></div>
						</div>
					</div>
				</div>
				<!-- FIN PARTAGE -->
