...
<head>
	...
	<?php
		...
		$urlimageaccueil = "http://www.ejc.fr/blog/src/2018/art18_012/1.png";
		$num_arc = "18_012"; //AA_NNN
...
$menu_source = file_get_contents('http://www.en.ejc.fr/menu_en_tete_en.html');
		...
		$arrayURL = array(1 => "src/2018/art18_012/1.jpg",2 => "src/2018/art18_012/2.jpg",3 => "src/2018/art18_012/3.jpg");
		$arrayLabel = array(1 => "Le DevCo au salon Vivatech", 2=> "Test de la réalité virtuelle pour Margot",3 => "Test de la reconnaissance vidéo pour Guillaume" );
			...
			<div class="container">
				...
				<div class="post">
					...
					<div id="blog-author" class="clearfix">
						<h3 class="heading"><span>The author:</span></h3>
						<img src="<?php echo $imgAuteur ?>" alt="author">
							<p>This article has been written by <?php if(booleanAuteur){echo $nom_auteur;}else{echo $nom_auteur.", ".$titreAuteur." chez Ensai Junior Consultant." ;} ?>.</p>
							<p>You can contact <?php echo $nom_auteur ?> by sending an e-mail to this adress: <?php echo $mail_ejc ?></p>
							<p>  </p>
					</div>
				...
				<div class="four columns">
					<div class="sidebar">
						<div class="widget">
							<div class="widget-title">Share the article</div>
								<div class="social-icon social-facebook"><a href="<?php echo "http://www.facebook.com/sharer.php?u=www.en.ejc.fr/art".$num_arc.".php" ?>" target="_blank" data-original-title="Facebook">Facebook</a></div>
								<div class="social-icon social-twitter"><a href="<?php echo "https://twitter.com/intent/tweet?text=www.en.ejc.fr/art".$num_arc.".php" ?>" target="_blank" data-original-title="Twitter">Twitter</a></div>
								<div class="social-icon social-linkedin"><a href="<?php echo "https://www.linkedin.com/sharing/share-offsite?mini=true&url=http://www.en.ejc.fr/art".$num_arc."&title=Blog de EjC - ".$titre."&summary=".$description."&source=ejc.fr" ?>" target=\"_blank\" data-original-title=\"LinkedIn\">LinkedIn</a></div>
						</div>
					</div>
				</div>
				<!-- FIN PARTAGE -->
			...
			<div class="clear"></div>
			  ...
			  <!-- START COPYRIGHT SECTION -->   	
				<div class="copyright clearfix">
					...
					<p>&copy; 2018 All rights reserved. E<em>j</em>C</br>
