...
<head>
	...
	<?php
		...
		$titre = "How do ski resorts track their visitors?";
		$sstitre = "";
		$description = "";
		$urlimageaccueil = "http://www.ejc.fr/blog/src/2020/art20_025/1bis.png";
		$num_arc = "20_027"; //AA_NNN
		$date_publ= mktime(0,0,0,3,13,2020); // heure minute seconde mois jour année
...
$menu_source = file_get_contents('http://www.en.ejc.fr/menu_en_tete_en.html');
		...
		$arrayURL = array(1 => "en/src/2020/art20_027/1.png");
		$arrayLabel = array(1 => "");
		...
		$corps="
<p>
At a time when big data is ubiquitous, it even follows
us on vacation, up to winter sports. Indeed, quite a
few ski resorts have launched their own application.
But you're probably wondering what these apps are
for. Well, in fact, they were created for visitors to track
their daily activity within the ski area.
Actually, these custom and scalable apps are included
in ski passes. With these applications tourists can
make a complete assessment of the sliding conditions
for skiing like a pro, they are aware of the crowd at
the ski lifts, and they can also retrace their journey
and know their performance in order to improve their
stick planting!
</p>

<p>
With the data collected by the application, there is
also an aim for the station: to collect, analyze and
centralize in real time all the data of the station and of
the tourists’ performances and \"thus obtain a 360 °
vision of its visitors. \"
</p>

<p>
The centralization of data thus allows the
implementation of targeted and personalized
marketing campaigns (emailing, adapted banners, etc.) with high value profile segments.
It also can help the station to make decisions, such as managing traffic on certain tracks.
</p>
";
	...
	<meta name="keywords" content="Ski,article,statistics,tracking, spying,Iris, Godinot,Ensai, junior, entreprise, junior-entreprise, JER, étude, big data, statistique, statistiques, stats, analyse, information, informatique, mathémathiques, maths"/>
