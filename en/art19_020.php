...
<head>
	...
	<?php
		...
		$titre = "Some EjC studies";
		$sstitre = "EjC makes you discover its work";
		$description = "";
		$urlimageaccueil = " URL IMAGE DE L'ACCUEIL DU BLOG";
		$num_arc = "19_020"; //AA_NNN
		$date_publ= mktime(0,0,0,12,24,2019); // heure minute seconde mois jour année
...
$menu_source = file_get_contents('http://www.en.ejc.fr/menu_en_tete_en.html');
		...
		$arrayURL = array(1 => "src/2019/art19_020/Bees_Consulting.png",2=> "src/2019/art19_020/CAH.png",3=> "src/2019/art19_020/FFBad.png",4=> "src/2019/art19_020/INED.png",5=> "src/2019/art19_020/M2S.png",6=> "src/2019/art19_020/Ministere_Culture.png");
		...
		$corps="
<p>
Ensai junior Consultant is specialized in statistics, but what kind of studies do we actually do? EjC has skills to conduct surveys 
(from the conception of the questionnaire to its analysis), quantitative marketing (for example customer segmentation), risk management, 
clinical trials and even studies in computer science (algorithm implementation, software migration, etc.) 
</p>
<p>
Whether you are a future consultant or a potential client, we will find the offer that fits your needs at Ensai junior Consultant! 
</p>
<p>
You may find a few examples of studies that EjC realized on our blog.
</p>
			...
			<div class="clear"></div>
			  ...
			  <!-- START COPYRIGHT SECTION -->   	
				<div class="copyright clearfix">
					...
					<p>&copy; <?php echo date('Y'); ?> All rights reserved. E<em>j</em>C</br>
