...
<head>
	...
	<?php
		...
		$titre = "Vlog CNH 2019";
		$sstitre = "Retour sur le Congrès National d'Hiver";
		$description = "";
		$urlimageaccueil = "http://www.ejc.fr/blog/src/2020/art20_025/01.png";
		$num_arc = "20_026"; //AA_NNN
		$date_publ= mktime(0,0,0,1,25,2020); // heure minute seconde mois jour année
...
$menu_source = file_get_contents('http://www.ejc.fr/menu_en_tete.html');
		...
		$arrayURL = array(1 => "src/2019/art19_021/01.png");
		$arrayLabel = array(1 => "EjC passe à l'oral" );

		// Informations concernant la vidéo youtube (si vidéo)
		$youtubeURL = "https://www.youtube.com/embed/NxQR4T7Un_g";
	...
	//Auteur de l'article
		...
		$corps= "
		 <p> 
		 Les 22, 23, et 24 novembre dernier s’est déroulé le dernier Congrès pour le mandat 2019 d’EjC : le Congrès National d’Hiver des Junior-Entreprises, à Seignosse. 
Ce fut le premier Congrès pour EjC en tant que finaliste d’un prix : celui de l’Engagement. 
		 </p>
		 <p>
			Nous tenions à remercier les partenaires de la CNJE : BNP Paribas Recrute, ALTEN, EY Careers, ENGIE et Saint-Gobain, pour cet évènement magique, convivial et riche en émotions ! </br>
Nous remercions également la Confédération Nationale des Junior-Entreprises pour l’organisation de ce Congrès, rdv au CNE avec le mandat 
2020 !
			</p>
...
<ul>
<li> <a href=\"https://www.facebook.com/EnsaiJuniorConsultant/\"> Facebook </a>
<li> <a href=\"https://www.linkedin.com/in/ensai-junior-consultant/\"> LinkedIn </a>
<li> <a href=\"https://twitter.com/EjC_35\"> Twitter </a>
<li> <a href=\"https://www.instagram.com/ejc_35/\"> Instagram </a>
