...
<head>
	...
	<?php
		...
		$titre = "Les grands domaines d’expertise de EjC";
		$sstitre = "Une expertise polyvalente";
		$description = "";
		$urlimageaccueil = "http://www.ejc.fr/blog/src/2020/art20_031/Vignette.png";
		$num_arc = "20_031"; //AA_NNN
		$date_publ= mktime(0,0,0,07,15,2020); // heure minute seconde mois jour année
...
$menu_source = file_get_contents('http://www.ejc.fr/menu_en_tete.html');
		...
		$arrayURL = array(1 => "src/2020/art20_031/1.png", 2 => "src/2020/art20_031/2.png",3 => "src/2020/art20_031/3.png" , 4 => "src/2020/art20_031/4.png" , 5 => "src/2020/art20_031/5.png" , 6 => "src/2020/art20_031/6.png");
		$arrayLabel = array(1 => "",2=> "", 3=> "" , 4=> "", 5=> "", 6=> "");
		...
		$nom_auteur = "Djalil Lekouara"; //"Prénom Nom" ou "le pôle XXX"
		$titreAuteur = "Djalil Lekouara"; //non utilisé si article écrit par un pôle. Exemple: "vice-présidente"
		$imgAuteur = "images/pole/djalil.jpg"; //URL de la photo de l'auteur
		$mail_ejc = "djalil.lekouara@ejc.fr";
...
<p>
Aujourd’hui, peu importe le type de structure, tout le monde possède des données en grand nombre. 
Cela implique donc des analyses variées et adaptées à de nombreux domaines différents. 
Analyses reposant essentiellement sur les statistiques, spécialité de notre Junior-Entreprise. 
En effet, il n’existe pas un seul secteur qui ne puisse pas bénéficier de notre expertise.  </p>

<p> Ainsi, Ensai junior Consultant propose des études diversifiées pour 6 grands domaines d’expertise : </p>
...
<p>
<li style=\"padding-left:40px\">
L’analyse et le profilage de clientèle
</li>
</p> 
...
<p>
<li style=\"padding-left:40px\">
La réalisation et l’exploitation d’enquêtes
</li>
</p> 

<p>
<li style=\"padding-left:40px\">
Les problématiques d’ingénierie financière
</li>
</p> 

<p>
<li style=\"padding-left:40px\">
La dynamisation de performance
</li>
</p> 

<p> Mais à quels besoins et problématiques concrètes sommes nous en mesure de répondre ? 
Quels sont nos atouts pour chacun de ces domaines et pourquoi nous faire confiance ? 
EjC s’est donnée pour objectif de répondre à ces questions dans le cadre de sa publication : 1 Semaine – 1 Domaine !
</p>
