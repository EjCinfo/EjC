...
<head>
	...
	<?php
		...
		$titre = "CNE 2019";
		$sstitre = "Retour sur le Congrès National d'Été";
		$description = "";
		$urlimageaccueil = "http://www.ejc.fr/blog/src/2019/art19_008/01.png";
		$num_arc = "19_008"; //AA_NNN
		$date_publ= mktime(0,0,0,5,29,2019); // heure minute seconde mois jour année
...
$menu_source = file_get_contents('http://www.ejc.fr/menu_en_tete.html');
		...
		$arrayURL = array(1 => "src/2019/art19_008/01.png");
		$arrayLabel = array(1 => "Retour sur le Congrès National d'Été 2019" );

		// Informations concernant la vidéo youtube (si vidéo)
		$youtubeURL = "https://www.youtube.com/embed/IVNg8LJyZ3c";
	...
	//Auteur de l'article
		...
		$corps= "
<p> Le weekend du 12 mai dernier, les 21 membres d’Ensai junior Consultant (EjC) se sont
rendus en Ardèche pour participer à la 100ème édition du Congrès National des JuniorEntreprises ! Ils ont pu partager et échanger avec pas moins de 1300 JuniorEntrepreneurs venant des quatre coins de la France, et se former via les différentes
formations dispensées par la Confédération Nationale des Junior-Entreprises et ses
partenaires (BNP Paribas, Alten, EY, Engie, Saint-Gobain, Prisma Media et Le Sphinx).
En effet, les administrateurs d’EjC ont pu choisir parmi 60 créneaux de formations leur
permettant de monter en compétences grâce à des formations spécialisées sur le
développement personnel. </br>
EjC a également eu l’opportunité – et cela dans une salle comble - de proposer une
formation portant sur la gouvernance en Junior-Entreprise et plus précisément sur la
gestion d’une équipe le temps d’un mandat. Nous tenons à remercier tous les JuniorEntrepreneurs présents lors de notre formation ainsi que la CNJE pour la confiance
accordée à notre structure. </br>
Le Congrès National d’Été était aussi l’occasion de célébrer les 50 ans du mouvement
des Junior-Entreprises et de récompenser les Junior-Entreprises s’étant distingués en
matière de conseil, de communication et d’ingénierie. Nous tenons à féliciter ETIC INSA
Technologies pour le prix d’excellence, Skema Conseil Lille pour le prix de la meilleure
étude de conseil et le prix du meilleur accompagnement des entrepreneurs, IÉSEG
CONSEIL Paris pour le prix de la meilleure stratégie de communication, SEIO - ESEO
Junior-Entreprise pour le prix de la meilleure étude en ingénierie et ESITC Etudes pour
le prix du meilleur espoir. </br>
Enfin, le CNE, c’est, avant tout, 3 jours inoubliables qui constituent des moments forts
de l'expérience Junior-Entrepreneur. </p>

<p> <center> <strong> EjC vous donne rendez-vous au Congrès National d’Hiver ! </strong> </center> </p>
";
