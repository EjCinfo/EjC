...
<head>
	...
	<?php
		...
		$titre = "Des études EjC";
		$sstitre = "EjC vous dévoile ses travaux";
		$description = "";
...
$menu_source = file_get_contents('http://www.ejc.fr/menu_en_tete.html');
		...
		$corps="
<p>
Ensai junior Consultant est spécialisée en statistiques, mais que réalisons-nous exactement comme études ? EjC est compétente pour réaliser des enquêtes 
(de la conception de questionnaire à l'analyse), du marketing quantitatif (segmentation de clientèle par exemple), de la gestion des risques, des essais 
cliniques et même des études plus informatiques (implémentation d'algorithme, migration de logiciel, etc).
</p>
<p>
Que vous soyez un futur consultant ou un potentiel client, vous trouverez l'offre qui correspond à vos besoins chez Ensai junior Consultant ! 
</p>
<p>
Retrouvez quelques études réalisées par EjC sur notre blog.
</p>
