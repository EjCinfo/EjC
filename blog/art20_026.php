...
<head>
	...
	<?php
		...
		$description = "";
		$urlimageaccueil = "http://www.ejc.fr/blog/src/2020/art20_024/01.jpg";
		$num_arc = "19_024"; //AA_NNN
		$date_publ= mktime(0,0,0,1,18,2020); // heure minute seconde mois jour année
...
$menu_source = file_get_contents('http://www.ejc.fr/menu_en_tete.html');
		...
		$arrayURL = array(1 => "src/2020/art19_021/01.jpg");
