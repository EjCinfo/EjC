...
<head>
	...
	<?php
		...
		$titre = "Dynamisez vos performances";
		$sstitre = "Ensai junior Consultant dynamise vos performances";
		$description = "";
		$urlimageaccueil = " URL IMAGE DE L'ACCUEIL DU BLOG";
		$num_arc = "19_006"; //AA_NNN
		$date_publ= mktime(0,0,0,04,24,2019); // heure minute seconde mois jour année
...
$menu_source = file_get_contents('http://www.ejc.fr/menu_en_tete.html');
		...
		$arrayURL = array(1 => "src/2019/art19_006/001.png");
		$arrayLabel = array(1 => "");
		...
		$corps="
<p>Dans un monde où les ressources se font toujours plus rares, ne plus gaspiller constitue un défi majeur, notamment en ce qui concerne l'énergie. Comment optimiser sa production sans gaspiller ses ressources ? Les statistiques représentent un outil essentiel afin de répondre à cette problématique.		

<p style=\"text-indent: 40px;\"> <strong> <li style=\"color: #1E90FF;\"> Ensai junior Consultant répond à cette problématique pour vous. </li> </strong> </p>

<p> Derrière l'intitulé « Dynamiser ses performances », EjC propose plusieurs types d'étude :
	<li style=\"padding-left:40px\"> diagnostic d'efficacité des processus ; </li>
	<li style=\"padding-left:40px\"> contrôle qualité et fiabilité ; </li>
	<li style=\"padding-left:40px\"> prévision et aide à la décision. </li>
</p>
 
<p> L'idée est d'appliquer des modèles statistiques (la régression linéaire par exemple) à vos données afin de décrire l'information et de prévoir l'évolution des phénomènes décelés. L'intérêt de décrire et de faire des prévisions est de pouvoir, par la suite, prendre des décisions pertinentes sur les actions à mener. Il est possible, par exemple, d'étudier sa consommation d'eau ou d'énergie en fonction de paramètres spécifiques (choisis au préalable) pour ensuite, mettre en place des mesures afin de l'optimiser (dans une optique de non-gaspillage, entre autres). De plus, ces modélisations permettent d'établir des diagnostics sur l'efficacité des processus ; on peut, par exemple, mesurer et comparer des rendements puis juger lequel est le meilleur suivant des critères spécifiques. Elle permettent également d'établir des diagnostics sur la qualité et la fiabilité des biens et services produits ; par exemple, à partir d'une modélisation, on peut déterminer la durée de fonctionnement d'un appareil voire trouver des solutions pour allonger cette dernière.
	<br> Décrire et modéliser l'information contenue dans ses données sont des outils essentiels afin de contrôler sa consommation et production. Ceci est d'autant plus important dans le cadre de la réduction du gaspillage et de la préservation de nos ressources, mais peut également s'appliquer à tout type d'objectif. </br>
</p>

<p style=\"text-indent: 40px;\"> <strong> <li style=\"color: #1E90FF;\"> Une spécialisation à l'Ensai : Génie Statistique </li> </strong> </p>

<p> Pour réaliser ce type d’étude, EjC recrute des consultants compétents de la filière Génie Statistique de l’Ensai. Cette filière est spécialisée dans la prédiction et la modélisation, son but principal est d'améliorer les modèles de régression linéaire lorsque ces derniers ne permettent pas de décrire de manière suffisante un phénomène. Ainsi, les consultants peuvent traiter tout type de données.
	<br> Dès le premier semestre, les élèves en troisième année peuvent mettre en pratique les enseignements théoriques dans des projets réalisés en autonomie. Enfin, ils réalisent un projet statistique de fin d’étude qui mobilise toutes les méthodes vues au long de la scolarité à l’Ensai et plus particulièrement celles axées sur la prédiction et la modélisation. Les sujets de ces projets sont, en partie, proposés par les entreprises partenaires de l’Ensai, telle que la SNCF ou encore la Banque de France. Les élèves sont alors confrontés aux problématiques du monde industriel durant leur scolarité, ce qui en fait des étudiants très recherchés sur le marché du travail. En effet le taux d’embauche est supérieur à 95% à la sortie de l’école. </br>
</p>

<p> N'attendez plus pour nous confier vos données ! </p>
