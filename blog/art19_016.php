...
<head>
	...
	<?php
		...
		$titre = "Entreprendre dans l'Ouest 2019";
		$sstitre = "EjC au salon Entreprendre dans l'Ouest 2019 !";
		$description = "";
		$urlimageaccueil = "http://www.ejc.fr/blog/src/2019/art19_016/01.png";
		$num_arc = "19_016"; //AA_NNN
		$date_publ= mktime(0,0,0,10,29,2019); // heure minute seconde mois jour année
...
$menu_source = file_get_contents('http://www.ejc.fr/menu_en_tete.html');
		...
		$arrayURL = array(1 => "src/2019/art19_016/01.png");
		$arrayLabel = array(1 => "EjC au salon Entreprendre dans l'Ouest 2019 !" );

		// Informations concernant la vidéo youtube (si vidéo)
		$youtubeURL = "https://www.youtube.com/embed/mSokYofnrJY";
		
	//Auteur de l'article
		$booleanAuteur = false; //true si écrit par un pôle, false si écrit par une personne
		$nom_auteur = "Nicolas Bertin"; //"Prénom Nom" ou "le pôle XXX"
		$titreAuteur = ""; //non utilisé si article écrit par un pôle. Exemple: "vice-présidente"
		$imgAuteur = "images/pole/nico.jpg"; //URL de la photo de l'auteur
		$mail_ejc = "nicolas.bertin@eleve.ensai.fr";
		// Corps de l'article
		...
		$corps= "
		 <p> Ensai junior Consultant s'est rendu pour la troisième année consécutive au salon Entreprendre dans l'Ouest. Nous avons eu la chance de tenir un stand, où nous avons pu acceuillir et conseiller de nombreux entrepreneurs pour la gestion et l'exploitation de leurs données. Ce salon est un véritable atout pour EjC, car il nous permet également de prospecter des entreprises sur le territoire Rennais, à proximité de notre école. </br>
		 
		 Nous avons également eu la chance de dispenser une formation « pitch » avec UBL pépite, durant laquelle nous avons accompagné plusieurs entrepreneurs dans la création de leur premier pitch, qui était ensuite filmé !
		 </p>
