...
<head>
	...
	<?php
		...
		$urlimageaccueil = "http://blog.ejc.fr/src/2020/art20_032/1.png";
		$num_arc = "22_001"; //AA_NNN
		$date_publ= mktime(0,0,0,2,1,2017); // heure minute seconde mois jour année
		...
		$corps= "
<p>Et si les matchs ne se gagnaient plus sur les terrains mais en dehors ? Et
...
données. C’est en effet ce que semblent indiquer les multiples articles et livres qui ne cessent d’émerger ces derniers temps. L’ouvrage de Gautier Stranget intitulé Le
football est une science (in)exacte parle de « datafication » du sport.</p>

<p><strong>Comment jongler avec les données ?</strong></p>
...
<p>Une date est révélatrice du pas dans cette nouvelle ère des données :
juillet 2015. Cette dernière marque l’annonce via une note par FIFA de
l’ « autorisation du port de système électroniques de suivi et
...
n’étaient autorisés qu’à l’entrainement.</p>

<p>Dès lors, se multiplient les plateformes recueillant les données des
...
Bundesliga et la Liga espagnole.</p>

<p><strong>L’aide à la décision en ligne de mire</strong></p>

<p>Ces données ont deux principales utilisations. Tout d’abord, comme ce fut le cas à l’origine
même de l’introduction du data dans le sport avec l’équipe de baseball des Athletics d’Oakland :
le recrutement. Il existe plus de 100 catégories de statistiques
spécifiques, individuelles sur les joueurs telles que tirs, buts,
passes décisives... Ces données peuvent alors orienter l’action
des clubs pour composer ou compléter une équipe. Mais à
condition qu’elles soient utilisées à bonne escient avec des
statisticiens spécialisés dans ce domaine qui puissent croiser
aux maximum les données.</p>

<p>En effet, que faudrait-il relever de la performance de Neymar,
...
systèmes se servant de la science des données a surtout servi à repérer des joueurs « sous-
côtés » en relevant chez eux des performances non directement visibles comme l’est le fait de
marquer un but.</p>
...
de forme de ses joueurs. C’est un réel appuie à la décision à la fois pour la composition mais
...
révéler le potentiel de ces données.</p>
";
