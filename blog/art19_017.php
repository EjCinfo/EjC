...
<head>
	...
	<?php
		...
		$titre = "Aftermovie du CRAO19";
		$sstitre = "EjC co-organisateur du Congrès Régional d'Automne de l'Ouest 2019 !";
		$description = "";
		$urlimageaccueil = "http://www.ejc.fr/blog/src/2019/art19_017/001.jpg";
		$num_arc = "19_017"; //AA_NNN
		$date_publ= mktime(0,0,0,11,24,2019); // heure minute seconde mois jour année
...
$menu_source = file_get_contents('http://www.ejc.fr/menu_en_tete.html');
		...
		$arrayURL = array(1 => "src/2019/art19_017/001.jpg");
		$arrayLabel = array(1 => "Congrès Régional d'Automne de l'Ouest 2019" );

		// Informations concernant la vidéo youtube (si vidéo)
		$youtubeURL = "https://www.youtube.com/embed/AZ6rrihR3ak";
