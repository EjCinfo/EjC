...
<head>
	...
	<?php
		...
		$sstitre = "EjC : une Junior engagée";
		$description = "";
		$urlimageaccueil = "http://www.ejc.fr/blog/src/2019/art19_018/001.jpg";
		$num_arc = "19_018"; //AA_NNN
		$date_publ= mktime(0,0,0,12,03,2019); // heure minute seconde mois jour année
...
$menu_source = file_get_contents('http://www.ejc.fr/menu_en_tete.html');
		...
		$arrayURL = array(1 => "src/2019/art19_018/001.jpg");
		$arrayLabel = array(1 => "L'engagement d'EjC" );

		// Informations concernant la vidéo youtube (si vidéo)
		$youtubeURL = "https://www.youtube.com/embed/yWWYHUokc30";
