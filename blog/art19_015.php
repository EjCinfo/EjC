...
<head>
	...
	<?php
		...
		$sstitre = "EjC en bref";
		$description = "";
		$urlimageaccueil = "http://www.ejc.fr/blog/src/2019/art19_015/001.png";
		$num_arc = "19_015"; //AA_NNN
		$date_publ= mktime(0,0,0,9,8,2019); // heure minute seconde mois jour année
...
$menu_source = file_get_contents('http://www.ejc.fr/menu_en_tete.html');
		...
		$arrayURL = array(1 => "src/2019/art19_015/001.png");
		$arrayLabel = array(1 => "Rejoignez EjC !" );

		// Informations concernant la vidéo youtube (si vidéo)
		$youtubeURL = "https://www.youtube.com/embed/3-tWoCYXlzs";
