...
<head>
	...
	<?php
		...
		$titre = "VivaTech 2019";
		$sstitre = "EjC au salon Viva Technology 2019 !";
		$description = "";
		$urlimageaccueil = "http://www.ejc.fr/blog/src/2019/art19_010/01.png";
		$num_arc = "19_010"; //AA_NNN
		$date_publ= mktime(0,0,0,6,10,2019); // heure minute seconde mois jour année
...
$menu_source = file_get_contents('http://www.ejc.fr/menu_en_tete.html');
		...
		$arrayURL = array(1 => "src/2019/art19_010/01.png");
		$arrayLabel = array(1 => "EjC au salon Viva Technology 2019 !" );

		// Informations concernant la vidéo youtube (si vidéo)
		$youtubeURL = "https://www.youtube.com/embed/f1l66PEXtBc";
		
	//Auteur de l'article
		$booleanAuteur = false; //true si écrit par un pôle, false si écrit par une personne
		$nom_auteur = "Louis Le Clainche"; //"Prénom Nom" ou "le pôle XXX"
		$titreAuteur = ""; //non utilisé si article écrit par un pôle. Exemple: "vice-présidente"
		$imgAuteur = "images/pole/louis.jpg"; //URL de la photo de l'auteur
		$mail_ejc = "louis.le-clainche@eleve.ensai.fr";
		// Corps de l'article
		...
		$corps= "
		 <p> Le vendredi 7 mai dernier, l'équipe d'Ensai junior Consultant (EjC) s'est rendue au salon Viva Technology 2019, qui avait lieu du 6 au 8 mai, afin de découvrir les nouveaux bijoux technologiques. </p>

		 <p> Le salon VivaTech2019, c’est le rendez-vous annuel des innovations technologiques et des startups à ne pas manquer, qui regroupe chaque année à Paris les grands noms de l'économie digitale et de la technologie du monde entier. Deux grandes salles dans le parc des expositions de Versailles, étaient mises à disposition pour que les start-ups, les entreprises et les multinationales puissent au mieux nous faire découvrir leurs merveilles. </br> 

		 L'équipe d'EjC a ainsi pu découvrir la voiture du futur de Citroën, les imprimantes 3D de pointe, les algorithmes de référencement de Facebook et de Google, essayer de contrôler un train de la SNCF avec une réalité augmentée, boire un verre dont le contenu est réalisé à partir d'un algorithme via des questions posées au préalable, et bien d'autres choses encore. </br>
		 Betty Bonnet et Mahalia Stepanoff, les deux membres du pôle développement commercial d'EjC, ont également prospecté durant ce salon, comme étant l’occasion de discuter avec beaucoup de professionnels de la Data Science et de mettre en avant notre Junior-Entreprise. VivaTech2019 nous a permis de discuter avec la marraine de promotion des premières années de notre école : Laure Debos. 
		 </p>
		 <p> Enfin, ce salon fut un moment d'échange avec les autres Junior-Entrepreneurs, ainsi qu’avec les membres de la CNJE (Confédération Nationale des Junior-Entreprises) présents que nous remercions sincèrement pour les places offertes. </p>
";
