...
<head>
	...
	<?php
		...
		$titre = "Les filles à l'Ensai";
		$sstitre = "Interviews";
		$description = "";
		$urlimageaccueil = "http://www.ejc.fr/blog/src/2019/art19_021/01.png";
		$num_arc = "19_021"; //AA_NNN
		$date_publ= mktime(0,0,0,12,26,2019); // heure minute seconde mois jour année
...
$menu_source = file_get_contents('http://www.ejc.fr/menu_en_tete.html');
		...
		$youtubeURL = "https://www.youtube.com/embed/zV_s4dyfH6s";
		
	//Auteur de l'article
		$booleanAuteur = true; //true si écrit par un pôle, false si écrit par une personne
		$nom_auteur = "le pôle communication et Djalil Lekouara, responsable Dev'Comm"; //"Prénom Nom" ou "le pôle XXX"
		...
		$corps= "
		 <p> 
		 L'Ensai est l'une des écoles d'ingénieurs qui compte le plus de filles en proportion ! Malgré cela, comment vit on dans un environnement 
		 toujours majoritairement masculin ? 
		 </p>
		 <p>
			Ainsi, Ensai junior Consultant a aujourd'hui décidé de mettre les étudiantes de l'Ensai à l'honneur. Que ce soit par leur ressenti 
			dans l'école, leur implication au coeur de la vie associative, mais aussi au sein de la Junior-Entreprise de l'école qui est une 
			introduction au monde du travail où la place des femmes est un enjeu primordial !
			</p>
