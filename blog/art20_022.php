...
<head>
	...
	<?php
		...
		$sstitre = "Qui aurait pu prédire que le nuage (cloud) serait un jour
tendance?";
		$description = "";
		$urlimageaccueil = "http://www.ejc.fr/blog/src/2020/art20_022/1bis.png";
		$num_arc = "20_022"; //AA_NNN
		$date_publ= mktime(0,0,0,1,8,2020); // heure minute seconde mois jour année
...
$menu_source = file_get_contents('http://www.ejc.fr/menu_en_tete.html');
		...
		$arrayURL = array(1 => "src/2020/art20_022/1.png");
		$arrayLabel = array(1 => "");
		...
		$titreAuteur = "Communication et Iris Godinot"; //non utilisé si article écrit par un pôle. Exemple: "vice-présidente"
...
développer de nouveaux produits et bien plus encore.
</br>
Naturellement, les entreprises du monde entier utilisent cette tendance à leur avantage, et le
secteur de la mode ne fait pas exception. Les concepteurs, les fabricants et les détaillants du vêtement
adoptent le Big Data de manière nouvelle et innovante.
</br>
Auparavant, l’industrie de la mode s’appuyait sur l’intuition et l’instinct pour décider de sa
...
mode réussissent à tirer profit des opportunités offertes par le big data.
</br>
Les différentes directions administratives des entreprises sont souvent déconcertées par la
...
celui des autres industries.
</br>
Les entreprises de mode qui tirent parti de la BI ont des marges d’exploitation supérieures de
54% en moyenne, selon WhichERP.com. Mais cette solution nécessite une attention constante pour
gérer, classer et analyser les données disponibles afin d’obtenir un retour sur investissement.
</p>
...
<p>
Grâce à l'accès à une telle richesse de données sur les consommateurs, les fabricants et les
développeurs peuvent rationaliser le cycle de vie de leurs produits à presque tous les niveaux, en
supprimant les stocks superflus.
</p>

<p>
Les marques de mode peuvent mesurer la réaction des clients aux échantillons et aux idées, puis
...
Le Big Data contribue directement à la socialisation du design. Traditionnellement, les
...
Dans une usine intelligente, toutes les machines et tous les systèmes nécessaires à la création d'un
produit sont connectés les uns aux autres, plutôt que via une unité de contrôle centrale.
</p>

<p>
De nos jours, les composants de production peuvent communiquer les problèmes liés aux stocks
...
<p>
Les entreprises peuvent classer leurs consommateurs en fonction de leur âge, sexe, appartenance
ethnique, lieu, etc. C’est un outil marketing très utilisé et qui offre d’énormes avantages.
</p>
<p>
Mais le Big Data va encore plus loin. Il peut être utilisé pour analyser le comportement des
clients sur une variété stupéfiante de facteurs. L’usage des réseaux sociaux peut être utilisé pour
mesurer l’engagement des consommateurs, le temps d’achat pour déterminer le moment où les gens sont le plus susceptibles d’acheter, et les points de contact peuvent être testés pour voir comment les
clients s’engagent avec une marque.
</br>
Des informations telles que celle-ci peuvent être utilisées pour créer des segments de clientèle
...
marques qui cherchent à améliorer leur capital et à affiner leurs communications.
</p>

<p style=\"text-indent: 40px;\"> <strong> <li style=\"color: #1E90FF;\"> CAMPAGNES DE COMMERCIALISATION PERSONNALISÉES </li> </strong> </p>
<p>
Tous les spécialistes du marketing savent que la personnalisation est essentielle à la création
d'une campagne marketing, en particulier dans le secteur de la mode.
</p>
<p>
Le Big Data peut capturer bien plus que des informations de base sur les clients. Il est possible
d’enregistrer et de mesurer toute une gamme de comportements des acheteurs, ce qui ne correspond
pas seulement à qui est un client, mais également à sa nature.
</br>
Les marques peuvent donc utiliser des données client détaillées pour créer des campagnes
d'emails hautement personnalisées.
</p>

<p style=\"text-indent: 40px;\"> <strong> <li style=\"color: #1E90FF;\"> POPULARITÉ DU GOÛT ET DU DESIGN </li> </strong> </p>

<p>
Cette analyse du comportement de la clientèle conduira également à une approche plus
...
déterminant qui achète quoi et pourquoi.
</p>
<p>
Là où auparavant les fashionistas dévouées attendaient avec impatience le défilé de la fashion
...
basées sur les données, et qui apportera inévitablement de plus grands avantages.
</p>

<p style=\"text-indent: 40px;\"> <strong> <li style=\"color: #1E90FF;\"> COMMERCE MOBILE / M-COMMERCE </li> </strong> </p>

<p>
Globalement, nous pouvons nous attendre à ce que le Big Data profite non seulement au
