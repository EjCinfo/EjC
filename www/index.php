...
<body class="onepage" data-spy="scroll" data-target=".navigation">
    ...
    <div class="card cookie-alert">
      <div class="card-body">
        ...
        <p class="card-text">Nous utilisons les cookies pour que vous passiez une bonne expérience sur notre site. Si vous les refusez, seuls les cookies nécessaires au fonctionnement du site seront gardés. 
        <br /> Merci aussi de bien lire les <a href ="mentions_légales.html"> mentions légales </a> avant de continuer sur notre site.</p>
        ...
        <div class="container">  
			    ...
			    <div class="tabset">
                      ...
                      <div class="panel" id="panel1">
						...
						EjC fonctionne comme une <span class="highlight">association pédagogique de conseil en statistique</span>. Elle met en relation les entreprises
		...
		<div class="container clearfix">
			<div class="parallax-content">
				<p class="quote" style="font-size: 150%"><i class="icon-quote-left"></i>
			        ENSAI junior Consultant c’est une Junior-Entreprise solide fondée sur des processus internes et des garanties de prestation établies qui lui ont permis de régulièrement faire partie de la liste des 30 meilleures JE de France depuis 2015. 
                                Fondée au cœur d’une des rares écoles de Data Sciences en France, notre équipe jeune et professionnelle prendra soin de révéler vos données en répondant à vos besoins statistiques, économétriques ou informatiques. 
                                </br></br>
				N’attendez plus pour faire fructifier vos données et confiez nous vos projets !
				<i class="icon-quote-right"></i></p>

				<div class="quote-author">Théophile Desolle, président d'EjC</div>

                                     <p class="quote" style="font-size: 150%"><i class="icon-quote-left"></i>
			              Depuis 2020, EjC a cherché à formaliser sa démarche RSE notamment grâce à la construction d’une charte pour encadrer son engagement disponible <a href="images/Charte RSE - EjC.pdf" class="link_image">ici</a> !
				<i class="icon-quote-right"></i></p>
...
<a href="http://www.ey.com/fr/fr/home" title="Partenaire" class="clients"><img src="images/clients2/ey2.png" alt="Partenaire"></a>
		   ...
		   <div class="container clearfix">
			...
			<div class="partenaire-logos">
			<h5> Cette année encore, ENSAI junior Consultant a eu la chance de parrainer Unilasalle Projets Rennes, structure de l'école UniLasalle Rennes, qui 
				propose des analyses environnementales. Notre parrainage est basé sur un développement commun, un échange de connaissances, et une
				aide toute particulière pour leur passage de marque au sein du mouvement des Junior-Entreprises. A travers ce parrainage se dessinent de
				nouvelles perspectives pour nos deux entités, notamment grâce à une posssibilité de collaboration sur des études alliant statistique et
				environnement. Nous entamons ainsi un mouvement de cohésion entre les Junior-Entreprises au sein du campus de Ker-Lann !</h5>
<div>
