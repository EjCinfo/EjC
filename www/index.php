        ...
        <div class="container">  
            ...
            <div class="row">
               ...
               <div class="four columns">
                 ...
                 <div class="milestone-counter" data-perc="26">
               ...
               <div class="img-container">
                    <img src="images/infographie.png" alt="Service Features">
                  </div>                                                                  
           </div><!-- END ROW -->
		</div><!-- END CONTAINER --> 
...
Fondée au coeur d’une des rares écoles de Data Sciences en France, notre équipe jeune et professionnelle prendra soin de révéler vos données en répondant à vos besoins statistiques, économétriques ou informatiques. 
</br></br>
				N’attendez plus pour faire fructifier vos données et confiez nous vos projets !
				<i class="icon-quote-right"></i></p>

				<div class="quote-author">Capucine Sans, présidente d'EjC</div>
...
<p class="quote" style="font-size: 150%"><i class="icon-quote-left"></i>
	...
	<div class="page">           
       ...
       <div id="team" class="fullwidth grey">
        ...
        <div class="fancy-header2">       
           <h2 class="highlight">MANDAT 2021</h2>
        </div>     
 
          <div class="container">	
            <center> <img src="images/Communication.png" alt="equipe2021">     
